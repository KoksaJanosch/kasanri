...
<html lang="en">
  <head>
    <meta charset="utf-8"/>
    <title>M &amp; M -- Design Firm Template</title>
  ...
  <body>
    <nav class="navbar">
      <div class="container text-center"><a href="index-slider.html"><img src="assets/images/logo/logo-dark.png" alt="logo" class="logo"/></a><a data-toggle="collapse" data-target="#side-menu" class="toggle-menu menu-right pull-right push-body nav-icon"><span class="sr-only">Toggle Navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a>
        <div class="collapse navbar-collapse center-block">
          <ul class="navbar-nav navigation-symbol">
            <li> <a href="#about">O MNĚ</a></li>
            <li> <a href="#services">OTÁZKY</a></li>
            <li> <a href="#works">WORKS</a></li>
            <li> <a href="#team">TEAM</a></li>
            <li> <a href="#testimonials">TESTIMONIALS</a></li>
            <li> <a href="#blog">BLOG</a></li>
            <li> <a href="#contact">CONTACT</a></li>
            <li class="dropdown"> <a data-target="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle">MORE <i class="caret"></i></a>
              <ul role="menu" class="dropdown-menu">
                <li> <a href="blog.html" class="dropdown-link">BLOG</a></li>
                <li> <a href="blog-post-single.html" class="dropdown-link">SINGLE POST</a></li>
                <li> <a href="blog-post-single-sidebar.html" class="dropdown-link">POST SIDEBAR </a></li>
              </ul>
            </li>
          </ul>
        </div>
        <div id="side-menu" class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right text-left"><img src="assets/images/logo/logo-light.png" alt="Logo"/><a href="#" class="close-menu"><i class="icon ion-ios-close-empty icon-close menu-close-btn"></i></a>
          <ul class="nav">
            ...
            <li> <a href="#blog">BLOG</a></li>
            <li> <a href="#contact">CONTACT</a></li>
            <li class="dropdown"><a href="#" class="expander">MORE <i class="caret"></i></a>
              <div class="content">
                <ul>
                  <li> <a href="blog.html">BLOG</a></li>
                  <li> <a href="blog-post-single.html">POST</a></li>
                  <li> <a href="blog-post-single-sidebar.html">POST SIDEBAR </a></li>
                </ul>
              </div>
            </li>
          </ul>
          <p class="copyright">COPYRIGHT © 2015  M &amp; M</p>
        </div>
      </div>
    </nav>
    ...
    <div class="full-height">
      <div id="head_panel_slider" class="owl-carousel">
        <div class="item full-height vertical-middle text-center section-overlay-dark background-slide-1">
          <div class="inner animated fadeIn minimal-white with-cross"><i></i>
            <h2>MINIMAL &amp; MODERN</h2><span class="animated fadeInUp">DESIGN FIRM</span>
          </div>
        </div>
        <div class="item full-height vertical-middle text-center section-overlay-dark background-slide-2">
          <div class="inner animated fadeIn minimal-white with-cross"><i></i>
            <h2>DETAILS MATTER</h2><span class="animated fadeInUp">BRANDING EXPERTS</span>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-offset-2 col-xs-12 col-md-8 padded">
            <div class="row">
              <div class="col-md-6 col-sm-12 padding-top margin-top">
                <h3 data-os-animation="fadeInUp" data-os-animation-delay="0s" class="os-animation">NA ZAČÁTEK</h3><span data-os-animation="fadeInUp" data-os-animation-delay="0s" class="os-animation"></span>
                <p data-os-animation="fadeInUp" data-os-animation-delay="0s" class="os-animation">
                  Jmenuji se <b>Richard Kasan </b>a jsem pianista z Uherské Hradiště. Piano je moje srdeční záležitost, začal jsem na něj hrát
                  v 7 letech na základní umělecké škole a vydrželo mi to až do mých 15 narozenin. Po krátké pauze jsem našel novou motivaci na
                  střední škole, kde jsem hrál pro pobavení spolužaček, ale také jsem doprovázel školní pěvecký sbor a scholu.
                  <br>
                  V roce <b>2016</b> začalo mé hraní v kavárně Jiné Café v Uherském Hradišti, kde hraji každou sobotu od 10-12 hodin
                  dopoledne. Od roku <b>2017</b> vystupuji na soukromých akcích, svatbách, veřírkách, či bálech jako Lounge pianist. Často mě
                  můžete zastihnout i na Zikmundově.
                </p><a href="#team" data-os-animation="fadeInUp" data-os-animation-delay=".2s" class="btn-link pull-left os-animation">MEET THE TEAM</a>
              </div>
              <div class="col-md-6 col-sm-12"><img style="padding-top:50px" src="assets/images/photos/8.jpeg" alt="About Image" class="small-screen-margin-top"/></div>
            </div>
          </div>
          <div class="col-md-4"><img src="assets/images/photos/7.jpeg" alt="About Image"/></div>
          <div class="col-md-4 margin-top padding-top">
            <h3 data-os-animation="fadeInUp" data-os-animation-delay="0s" class="os-animation"> Kde jsem se naučil hrát a kde beru inspiraci?</h3><span data-os-animation="fadeInUp" data-os-animation-delay="0s" class="os-animation"> </span>
            <p data-os-animation="fadeInUp" data-os-animation-delay="0s" class="os-animation"> 
              Chodil jsem 7 let na ZUŠ, kde jsem se naučil takový základ jako noty,
              dynamiku. Nicméně pořádně cvičit na piano jsem začal na střední kvůli holkám (tehdy mě to zachránilo, neboť jsem chtěl s
              hudbou skončit). Od té doby se inspiruji a učím sám. Každopádně cvičím a učím se neustále, vždy je co zlepšovat!
            </p>
            <ul data-os-animation="fadeInUp" data-os-animation-delay="0s" class="featured-list text-left os-animation">
              ...
              <li> Hungry for new projects</li>
              <li> Punctual people</li>
            </ul>
          </div>
          <div class="col-md-4 padding-top-huge small-screen-no-padding">
            <p data-os-animation="fadeInUp" data-os-animation-delay=".2s" class="os-animation">
              Mým životním idolem je můj dědeček, který hraje na piano přes 70 let. Mám i další vzory, kterými jsou také pianisti z
              Youtube jako Jacob Koller, Scott Bradlee (zakladatel Postmodern jukebox), Johny May, Peter Bence, Francesco Parrino,
              Sangah Noona a další. Od každého z nich si beru inspiraci a tím vytvářím svůj styl hraní.
            </p><a href="#contact" data-os-animation="fadeInUp" data-os-animation-delay=".2s" class="btn-link pull-left os-animation"> CONTACT US</a>
          </div>
        </div>
      </div>
    </section>
    <section id="video-intro" class="section section-nopadding-bottom section-black text-center">
      <header class="section-head padded-big">
        <h2>YOUTUBE KANÁL</h2>
        <p>Videa, jak to umím s piánem najdete na mém kanále.</p>
      </header>
    ...
    <section id="services" class="section section-dark text-center padding-bottom-fix">
      <div class="container">
        ...
        <div class="row">
          <div data-os-animation="fadeInUp" data-os-animation-delay="0s" class="col-md-3 os-animation">
            <div class="icon-block icon-block-dark"><i class="ion-ios-glasses-outline"></i>
              <h3>Jaká je cena?</h3>
              <p>Na každé hraní se domlouvám individuálně. Záleží na požadavcích, vzdálenosti, technice, délce hraní a zda se jedná o
              dlouhodobou spolupráci.</p>
            </div>
          </div>
          <div data-os-animation="fadeInUp" data-os-animation-delay=".1s" class="col-md-3 small-screen-margin-top os-animation">
            <div class="icon-block icon-block-dark"><i class="ion-ios-lightbulb-outline"></i>
              <h3>Jaký je můj repertoár?</h3>
              <p>
                Miluji téměř všechny hudební žánry. Hraji jazz, filmovou hudbu, romantické písně, klasiku, pop, rock, evergreeny, zkrátka
                vše na co si vzpomenete.
              </p>
            </div>
          </div>
          <div data-os-animation="fadeInUp" data-os-animation-delay=".2s" class="col-md-3 small-screen-margin-top os-animation">
            <div class="icon-block icon-block-dark"><i class="ion-ios-film-outline"></i>
              <h3>Kdy mi napsat?</h3>
              <p>Znáte to, čím dříve, tím lépe! Nestane se pak, že budu v termínu Vaší akce už obsazen.</p>
            </div>
          </div>
          <div data-os-animation="fadeInUp" data-os-animation-delay=".3s" class="col-md-3 small-screen-margin-top os-animation">
            <div class="icon-block icon-block-dark"><i class="ion-ios-pie-outline"></i>
              <h3>ANALYTICS</h3>
              <p>A appear very seed day tree whose above into She'd divide multiply wherein fifth light heaven multiply but isn't thing from sea, heaven. Fowl they're if they don't.</p>
            </div>
          </div>
          <div class="col-md-8 col-md-offset-2 padding-top margin-top small-screen-margin-top"><img src="assets/images/services-image.jpg" alt="Service Image"/></div>
        </div>
      </div>
    </section>
    ...
    <section id="team" class="section section-lighter text-center">
      <div class="container">
        <header class="section-head"><span>04</span>
          <h2>TEAM</h2>
          <p>An all-star team ready to serve you</p>
        </header>
        <div class="row">
          <div class="col-md-4 col-md-offset-4 team-intro"><span></span>
            <h3>TEAM QUALIFICATIONS</h3>
            <p>Blessed earth have fowl itself deep third likeness yielding itself<strong> team </strong>give were. Together may make won't darkness isn't unto doesn't our i. Above be very herb also dominion. Life, is about them. Hath moved every greater saying it the, saying called isn't fowl doesn't earth creepeth without over every i land sea, moving bring second face he every divided air. From morning there, void won't and blessed fowl. Moved. The you're us.</p>
          </div>
          <div class="col-md-12 margin-top">
            <div class="row">
    ...
    <section id="blog" class="section section-dark text-center">
      <div class="container">
        <header class="section-head"><span>06</span>
          <h2>BLOG</h2>
          <p>Curated stories and news across our team</p>
        </header>
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <div class="row">
              <div data-os-animation="fadeInUp" data-os-animation-delay="0s" class="col-md-12 blog-post-full-width os-animation"><a href="#blog-gallery" data-slideid="0" class="open-gallery-link"><img src="assets/images/blog-image-1.jpg" alt="Author"/>
                  <div class="blog-post-author"> <img src="assets/images/team-member-3-avatar.jpg" width="40" height="40" alt="Author" class="img-circle"/>
                    <h5>MARCELA DOIN</h5>
                  </div></a>
                <div class="row">
              ...
              <div data-os-animation="fadeInUp" data-os-animation-delay="0s" class="col-md-12 blog-post-full-width margin-top os-animation"><a href="#blog-gallery" data-slideid="1" class="open-gallery-link"><img src="assets/images/blog-image-2.jpg" alt="Author"/>
                  <div class="blog-post-author"> <img src="assets/images/team-member-2-avatar.jpg" width="40" height="40" alt="Author" class="img-circle"/>
                    <h5>NATHANIEL DOE</h5>
                  </div></a>
                <div class="row">
                  <div class="col-md-10 col-md-offset-1">
              ...
              <div data-os-animation="fadeInUp" data-os-animation-delay="0s" class="col-md-12 blog-post-full-width margin-top os-animation"><a href="#blog-gallery" data-slideid="2" class="open-gallery-link"><img src="assets/images/blog-image-3.jpg" alt="Author"/>
                  <div class="blog-post-author"> <img src="assets/images/team-member-1-avatar.jpg" width="40" height="40" alt="Author" class="img-circle"/>
                    <h5>JACK RUSS</h5>
                  </div></a>
                <div class="row">
                  <div class="col-md-10 col-md-offset-1">
          ...
          <div data-slideid="0" class="slide">
            <div class="row">
              <div class="col-md-12 text-center modal-intro background-blog-single modal-text-light section-overlay-dark">
                <div class="container padding-top padding-bottom"><img src="assets/images/team-member-3-avatar.jpg" alt="Author" class="img-circle"/><span>MARCELA DOIN</span>
                  <h1>WHY MARKETING  PLAN IS ESSENTIAL</h1>
                  <div class="read-time vertical-align"><i class="ion-ios-clock-outline"></i><span>3 	MINUTES</span></div>
                </div>
              </div>
            </div>
            <div class="container">
    ...
    <section id="contact" class="section section-lighter text-center">
      <div class="container">
        <header class="section-head"><span>07</span>
          <h2>CONTACT</h2>
          <p>For any bussiness inquiries, don't hesitate to reach us</p>
        </header>
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              <div data-os-animation="fadeInUp" data-os-animation-delay="0s" class="col-md-4 icon-block icon-block-dark os-animation"><i class="ion-ios-telephone"></i>
                <h3>CALL US</h3>
                <p class="text-center">+030 - 555 - 4032</p>
              </div>
              <div data-os-animation="fadeInUp" data-os-animation-delay=".2s" class="col-md-4 icon-block icon-block-dark small-screen-margin-top os-animation"><i class="ion-ios-flag"></i>
                <h3>LOCATION</h3>
                <p class="text-center">8th Avenue - New York 8845</p>
              </div>
              <div data-os-animation="fadeInUp" data-os-animation-delay=".4s" class="col-md-4 icon-block icon-block-dark small-screen-margin-top os-animation"><i class="ion-ios-email"></i>
                <h3>E-MAIL</h3>
                <p class="text-center">adreasch@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-md-offset-3 margin-top">
            <form id="contact_form" method="POST" class="contact-form text-center row">
              ...
              <div class="col-md-12">
                <p class="required-message">* Please, fill all the fields</p>
                <input type="submit" value="SUBMIT" class="contact-form-submit btn btn-success"/>
              </div>
    ...
    <footer class="footer-dark">
      <div class="text-center container">
        ...
        <div class="row">
          <div class="col-md-12">
            <p class="footer-message">COPYRIGHT © 2015  M &amp; M - CRAFTED WITH <i class="ion-heart"></i> BY <a href="http://andrewch.eu">ANDREW CHS</a> </p>
          </div>
        </div>
        <div class="clear"></div>
      </div>
